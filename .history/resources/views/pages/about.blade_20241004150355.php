    ...
    <section class="section" id="section4">
        <div class="container">
            ...
            <div class="about-wrapper about-box">
                <div class="about-tab">
                    <div class="about-tab-item active" data-title="wrapper-1">Chính sách chất lượng</div>
                    ...
                    <div class="about-tab-item" data-title="wrapper-4">Chính sách an toàn</div>
                </div>
                <div class="about-content">
                    <div class="wraptext wrapper-1 active">
                        <div class="about-content-title">Chính sách chất lượng</div>
                        <a href="#" class="about-content-btn">Tải văn bản</a>
