    ...
    <section class="section" id="section2">
        <div class="container">
            ...
            <div class="about-wrapper">
                ...
                <div class="about-text">
                    Công ty Cổ phần Chứng nhận và Giám định MekongCert là tổ chức hoạt động độc lập trên toàn lãnh thổ Việt Nam với các lĩnh vực Chứng nhận, Giám định, Thử nghiệm, Quan trắc môi trường, Tư vấn và Đào tạo. Công ty cung cấp cho khách hàng trong và ngoài nước các dịch vụ như sau:
                </div>
                <div class="about-p">MekongCert cam kết:</div>
                <ul class="about-ul">
                    <li>Mang lại nhiều lợi ích cho khách hàng trong mỗi lần đánh giá:</li>
