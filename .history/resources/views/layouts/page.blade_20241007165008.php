            ...
            <div class="search-body-content">
                <div class="container-search">
                    <div class="search-top">
                        ...
                        <span class="btn-search-close"><i class="bx bx-x"></i></span>
                    </div>
                    <div class="search-bottom">
                        <form action="{{url('search')}}" class="form-search" method="POST">
                        @csrf
                            <input type="search" class="search_input" name="keyword" placeholder="Tên tour hoặc địa điểm ...">
                            <button type="submit" class="btn-search-submit"><i class="bx bx-search"></i></button>
                        </form>
                    </div>
                </div>
            </div>
