                            ...
                            <div class="ft-context">
                                <div class="ft-group">
                                    ...
                                    <div class="ft-group-col col-1">
                                        ...
                                        <a href="#" class="ft-link"><i class="fa-solid fa-caret-right"></i> Chính sách bảo mật</a>
                                        <a href="#" class="ft-link"><i class="fa-solid fa-caret-right"></i> Điều khoản sử dụng</a>
                                    </div>
                                </div>
                            </div>
                        </div>
