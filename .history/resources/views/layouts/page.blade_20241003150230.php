                                    ...
                                    <div class="submenu">
                                        <ul class="submenu-list">
                                            <li class="submenu-item">
                                                <a href="#" class="submenu-link">Giới thiệu chung</a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="#" class="submenu-link">Chức năng, <br> phạm vi hoạt động</a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="#" class="submenu-link">Thông tin <br> năng lực</a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="#" class="submenu-link">Chính sách chất lượng</a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="#" class="submenu-link">Ban lãnh đạo</a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="#" class="submenu-link">Sơ đồ tổ chức</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
