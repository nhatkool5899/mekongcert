                                    ...
                                    <div class="submenu">
                                        <ul class="submenu-list">
                                            <li class="submenu-item">
                                                <a href="{{ route('about') }}" class="submenu-link" data-section="section1">
                                                    <div class="icon">
                                            ...
                                            <li class="submenu-item">
                                                <a href="{{ route('about') }}" class="submenu-link" data-section="section2">
                                                    <div class="icon">
                                            ...
                                            <li class="submenu-item">
                                                <a href="{{ route('about') }}" class="submenu-link" data-section="section3">
                                                    <div class="icon">
                                            ...
                                            <li class="submenu-item">
                                                <a href="{{ route('about') }}" class="submenu-link" data-section="section4">
                                                    <div class="icon">
                                            ...
                                            <li class="submenu-item">
                                                <a href="{{ route('about') }}" class="submenu-link" data-section="section5">
                                                    <div class="icon">
                                            ...
                                            <li class="submenu-item">
                                                <a href="{{ route('about') }}" class="submenu-link" data-section="section6">
                                                    <div class="icon">
